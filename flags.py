...
parser.add_argument("--C_y",type=str,help="Whether use downsample")
parser.add_argument("--residual", type=bool,default=True,help="Whether use residual in forward")
parser.add_argument("--attr_objs_fc_emb", default='768,1024,1200',help="layers dimensions")
parser.add_argument("--IC",type=bool,default=True,help="Whether use additional_information")
parser.add_argument("--smooth_factor",type=float,default=0.2)
parser.add_argument("--latent_dim",type=int,default=1024)
parser.add_argument("--eta",type=float,default=1.1)
parser.add_argument("--if_ds",type=bool,default=True)
